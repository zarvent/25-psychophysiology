...
export default function Home() {
  return (
    <main className="flex flex-col lg:flex-row min-h-screen items-stretch p-4 sm:p-6 md:p-8 gap-6 md:gap-8 bg-gradient-to-br from-background to-muted/30 overflow-hidden">
