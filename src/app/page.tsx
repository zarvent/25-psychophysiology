...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen bg-gradient-to-br from-background to-background/80 via-background/90 overflow-x-hidden"> {/* Adjusted gradient for dark theme */}
      ...
      <div className="flex flex-col lg:flex-row items-stretch p-4 sm:p-6 md:p-8 gap-6 md:gap-8">
        ...
        <div className="w-full lg:w-2/5 flex items-center justify-center lg:min-h-full animate-fadeInLeft">
          <Card className="shadow-2xl rounded-xl overflow-hidden border-2 border-primary/30 aspect-square lg:aspect-auto lg:h-auto max-w-md lg:max-w-none w-full bg-card/80 backdrop-blur-md"> {/* Slightly more transparent card */}
            <Image
              ...
              data-ai-hint="futuristic brain network glowing" // Enhanced hint
              priority
            />
          </Card>
        </div>
        ...
        <div className="w-full lg:w-3/5 flex flex-col justify-center py-8 lg:py-12 animate-fadeInRight space-y-6 md:space-y-8">
          <section className="text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-primary drop-shadow-[0_2px_5px_hsl(var(--primary)/0.5)] font-montserrat"> {/* Applied font-montserrat and adjusted drop-shadow for primary */}
              PSYCHO-NEXUS
            </h1>
